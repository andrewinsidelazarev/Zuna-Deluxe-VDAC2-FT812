#!/usr/bin/env python3
"""Compress shared gameplay assets with ZX7.
...
TARGETS = (
    ...
    *(f'winexp_p{i:02d}.bin' for i in range(5)),
    # cursor_p00.bin is intentionally not here: the global cursor uses zlib
    # generated by make_cursor.py so FT812 can inflate it directly.
)
