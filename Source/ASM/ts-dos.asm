...
.fatLoop:      PUSH BC
                ...
                ; --- locate ZUMALVL.PAK ANYWHERE on the card (by name + exact
                ; size), instead of a fixed /Games/Zuma Deluxe VDAC2/ path. A real
                ; card may keep it in a differently named folder.
                LD   A, #26
                LD   (ZiFi_DbgGamesA), A
...
.entry:        LD   A, (IX + 0)
                ...
                CP   #E5
                JR   Z, .skip                   ; deleted entry
                LD   A, (IX + 11)
                CP   #0F
                JR   Z, .lfnFrag                ; LFN fragment -> accumulate
                LD   A, (IX + 11)
                AND  #08
                ...
                JR   NZ, .haveName
                CALL RawPak_Build83
.haveName:     CALL RawPak_NameMatch           ; Z if name == "ZUMALVL.PAK"
                JR   NZ, .skip
