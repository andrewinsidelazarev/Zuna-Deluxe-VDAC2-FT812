...
LevelSelect:
                ...
                LD   HL, 0
                LD   (LevelSelectSkyPos), HL
                XOR  A
                LD   (LevelSelectSkyFrac), A
...
.play:          JP   FadeLevelSelectToGameplay
...
LevelSelectAdvanceSky:
                ...
                JR   C, .store_pos
                LD   HL, 0
.store_pos:     LD   (LevelSelectSkyPos), HL
.store_frac:    LD   (LevelSelectSkyFrac), A
                RET
...
LevelSelectSkyPos:              DEFW 0
LevelSelectSkyFrac:             DEFB 0
