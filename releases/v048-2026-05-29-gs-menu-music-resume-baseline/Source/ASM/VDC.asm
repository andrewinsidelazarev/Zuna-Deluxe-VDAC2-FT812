...
.has2:          LD   A, 1
                ...
                ; Dual-curve boards need a full fast-fill on each path. The
                ; single-chain level setting (35) leaves the second train visibly
                ; cut short on long paths such as L05.
                ...
                LD   A, H
                LD   (DE), A
                LD   DE, VDC2_ChainLocal + (VDC_LevelStart - VDC_ChainLocalStart)
                LD   A, (VDC2_ChainLocal + (VDC_TrackNumSlots - VDC_ChainLocalStart))
                LD   (DE), A
                LD   HL, (TrackData)
                DEC  HL
