...
MenuSwapFrame:
                ; 1024×768: (1) vsync-синхронизация как в MainLoop — без неё частота
                ; кадров сцены плавает (дёрганый курсор/скролл); (2) отправка кадра
                ; DMA-путём (резидентный ZL_FT_CMD_Write_DMA) вместо медленного OTIR.
