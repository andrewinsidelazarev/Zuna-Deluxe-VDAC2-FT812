...
def main() -> int:
    ...
    if "CP   DLG_WIN_DONE" not in frog_layer or ".draw_until_dialog_loaded:" not in frog_layer:
        failures.append("win-done dialog hides frog before dialog frame is actually loaded")
