...
def ramg_ranges() -> list[Range]:
    return [
        ...
        Range("gameplay", "FONT_LEVEL48", 0x004000, 0x00C000, "native-48 LEVEL N-M font, 2x16K (replaced dead TEXT_LEVEL11+TEXT_SPIRALDOOM)"),
        ...
        Range("level_select", "LOADING_TEXT", 0x084000, 0x08C000, "pre-rendered LOADING banner, must survive the PAK search shown over it"),
