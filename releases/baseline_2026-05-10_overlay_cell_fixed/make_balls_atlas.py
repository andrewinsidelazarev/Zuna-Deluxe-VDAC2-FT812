...
CELL_SRC = 32
CELL_BALL = 40                                    # видимый диаметр ball
CELL_DST = 56                                     # ячейка с паддингом
PAD = (CELL_DST - CELL_BALL) // 2                 # 8 px по краям
N_COLORS = 6
N_FRAMES = 8                                      # native rolling-цикл (8 phases — экономия RAM_G для overlay 122)
PAGE_SZ  = 16384
START_PAGE = 0x2D
