...
; Порядок строго как в Python emulator: move_chain → animate_chain → try_spawn.
; (try_spawn после animate чтобы новый шар спавнился ПОСЛЕ match-cascade shift'а
; — иначе при одновременном spawn+match новый шар встаёт на stale slot.)
; ============================================================================
VDC_Update:
                CALL VDC_MoveChain
