...
def main() -> int:
    ...
    profiles["gameplay"] = [
        ...
        ("TOP_MASK_A", a("TOP_MASK_RAMG_A"), a("TOP_MASK_RAMG_A_END") - a("TOP_MASK_RAMG_A"), "active tunnel top L4 masks"),
        ...
        ("DIALOG_FRAME", a("DIALOG_FRAME_RAMG"), 8 * PAGE, "400x327 PALETTED4444"),
        ...
        ("TOP_MASK_B", a("TOP_MASK_RAMG_B"), a("TOP_MASK_RAMG_B_END") - a("TOP_MASK_RAMG_B"), "active tunnel top L4 masks"),
    ]
    ...
    profiles["level_select"] = [
        ...
        ("LS_PREVIEW_MARK/FROG/KZ", a("LS_PREVIEW_MARKER_RAMG"),
         a("LS_PREVIEW_KZ_RAMG") + 39 * 39 * 2 - a("LS_PREVIEW_MARKER_RAMG"), "превью-маркеры"),
        ("LS_PREVIEW_BG", a("LS_PREVIEW_BG_RAMG"), 0x16580, "превью фона уровня"),
    ...
    uploads: list[tuple[str, int, int, str]] = [
        ...
        ("game:top_mask_a_raw", a("TOP_MASK_RAMG_A"), a("TOP_MASK_RAMG_A_END") - a("TOP_MASK_RAMG_A"), "active tunnel top L4 masks"),
        ("game:top_mask_b_raw", a("TOP_MASK_RAMG_B"), a("TOP_MASK_RAMG_B_END") - a("TOP_MASK_RAMG_B"), "active tunnel top L4 masks"),
        ...
        ("level_select:preview_bg_stream", a("LS_PREVIEW_BG_RAMG"), 0x18000, "6 pages from ZUMALVL preview bg"),
        ("level_select:loading_text_pages", a("LOADING_TEXT_RAMG"), 2 * PAGE, ""),
    ]

    problems: list[str] = []
    for prof in ("boot_loading", "main_menu", "level_select", "more_games", "gameplay", "win_state"):
