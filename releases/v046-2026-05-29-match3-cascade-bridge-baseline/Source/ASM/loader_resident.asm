...
; (pre-rendered nativealien48 48px ARGB4, тот же шрифт/градиент, что и LEVEL N-M).
...
DrawLoadingScreen:
                ...
                FT_BitmapSize   FT_NEAREST, FT_BORDER, FT_BORDER, LOADING_TEXT_W, LOADING_TEXT_H
                FT_Vertex2ii (640 - LOADING_TEXT_W) / 2, (480 - LOADING_TEXT_H) / 2, LOADING_TEXT_HANDLE, 0
                FT_End
                FT_Display
                FT_CMD_Count
