...
with open(os.path.join(CONVERTED, 'balls_atlas.bin'), 'wb') as f:
    f.write(out)
...
for i in range(n_pages):
    ...
    with open(os.path.join(CONVERTED, f'balls_atlas_p{i:02d}.bin'), 'wb') as f:
        f.write(chunk)
...
atlas.save(os.path.join(TEMP_DIR, '_balls_atlas_preview.png'))
