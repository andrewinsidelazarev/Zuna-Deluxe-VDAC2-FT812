...
def main() -> int:
    ...
    lines += [
        "",
        "; [LevelSelectApplyLevelClick — дубликат удалён 2026-06-09: живая версия в",
        ";  LevelSelect.asm (overlay #41), вызывается оттуда же.",
        ";  Эта page-0 копия была мёртвой; не генерируем её, чтобы не вернуть wrap",
        ";  на board 22, который доступен только как WIN-state после 21-4.]",
    ]
