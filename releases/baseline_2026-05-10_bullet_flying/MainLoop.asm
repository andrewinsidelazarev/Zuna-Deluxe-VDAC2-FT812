...
.WaitDLSwap     FT_RD_REG8 FT_REG_DLSWAP
                ...
                CALL ZL_AimUpdate                     ; detect mouse motion, keyboard → Frog_Angle
                CALL ZL_SmoothMouse                   ; low-pass на raw mouse → SmoothX/Y
                ...
                ; --- 1c. Bullet update (полёт, deactivate за экран).
                CALL Bullet_Update
