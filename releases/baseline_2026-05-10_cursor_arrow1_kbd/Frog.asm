...
FROG_BALL_W       EQU 56                                ; ball atlas cell size в RAM_G (= screen size, native)
FROG_BALL_DST_W   EQU 56                                ; screen size = native (оригинальный размер)
FROG_BALL_DST_HALF EQU 28
...
; ----------------------------------------------------------------------------
; Frog_Update — вычислить angle к курсору + обработать выстрел/recoil.
; ----------------------------------------------------------------------------
Frog_Update:      CALL Frog_ComputeAngle
