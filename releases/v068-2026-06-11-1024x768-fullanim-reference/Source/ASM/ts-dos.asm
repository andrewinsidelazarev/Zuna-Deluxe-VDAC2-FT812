...
OVL_DrawBootSfxAuthors:
                ...
                FT_BitmapSize   FT_NEAREST, FT_BORDER, FT_BORDER, BOOT_SFX_AUTHORS_W, BOOT_SFX_AUTHORS_H
                LD   A, (BootAnimFrame)
                OR   A
                JP   Z, .spritesDone
                CP   1
                ...
                FT_Vertex2ii 102, 266, BOOT_SFX_AUTHORS_HANDLE, 0
                JP   .spritesDone
.claudeFull:    FT_ColorA 255
                ...
                JP   NZ, .codexFull
                CALL OVL_BootSfxFadeAlpha
                FT_Vertex2ii 180, 266, BOOT_SFX_AUTHORS_HANDLE, 1
                JP   .spritesDone
